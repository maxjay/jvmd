...
class HotSwapBudgetTest {
    ...
    @Test void methodBodySwapMeetsTheEndToEndBudgetUnderStrictAot()throws Exception{
        ...
        String source="public class Probe { static Class<?> metadata(){return java.beans.Introspector.class;} static int value(){return %d;} public static void main(String[] args)throws Exception { while(true){value();Thread.sleep(20);} } }";
