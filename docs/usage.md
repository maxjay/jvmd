...
The CI budgets are startup 600 ms, session open 200 ms, focused attribution 50 ms, depth-three documentation 50 ms, attach 500 ms, Maven 3 cold resolution 1000 ms, Maven 4 cold resolution 1500 ms, cached resolution 5 ms for both majors, and a complete method-body hot-swap request 100 ms. The Maven 4 cold allowance was raised from 1000 ms at the user's request on 2026-09-15. These are test assertions, not production request deadlines. Measurements and test reports are uploaded as CI artifacts. See [DEPENDENCIES.md](../DEPENDENCIES.md) for pinned dependencies and their rationale.
