...
public class Lifetime {
    ...
    public static void main(String[] args)throws Exception {
        ...
        try(var cache=new WorkspaceBindings()){
            ...
            for(int i=0;i<31;i++){long start=System.nanoTime();var view=InputNavigation.get(cache,()->files,List.of(root),List.of(),docs,"test",budget,loader);try{if(symbol(view,"local Type63")==null)throw new AssertionError();}finally{if((Object)view instanceof AutoCloseable lease)lease.close();}times.add((System.nanoTime()-start)/1e6);}
