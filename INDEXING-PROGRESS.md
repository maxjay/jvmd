...
- [~] **15 — Performance/correctness acceptance gate.** The retained isolated 40,000-symbol three-run comparison reports SQLite/Rocks median seed 6.404/9.558 s, writes 74.47/38.98 MB and query p95 18.57/13.22 ms. Rocks queries and size improve, but seed, write-reduction and memory targets remain unproven or failed. All unchanged restarts perform zero artifact rebuilds/global links. The corporate corpus is unavailable in this environment.
